...
class GoForwardAvoid():
	def __init__(self):
		rospy.init_node('self_drive_mode', anonymous=True)
		...
		print('Before move base goal')
		goal = MoveBaseGoal()
		print(goal)
		goal.target_pose.header.frame_id = 'footprint'
		goal.target_pose.header.stamp = rospy.Time.now()
		goal.target_pose.pose.position.x = 3.0 #3 meters
		#goal.base_position.pose.position.x = 3.0 #3 meters
